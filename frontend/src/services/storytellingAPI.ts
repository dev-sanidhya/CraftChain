...
const API_BASE_URL =
  (import.meta as any).env?.VITE_STORYTELLING_API_URL ||
  "http://127.0.0.1:8009";
    ...
    try {
      const requestBody = {
        ...
        materials: productInfo.materials
          ? productInfo.materials.split(",").map((m) => m.trim())
          : undefined,
      ...
      return {
        ...
        story: {
          ...
          heritage_story:
            data.story || "Unable to generate story at this time.",
          cultural_context: {
            region: data.heritage || productInfo.region || "Unknown",
            historical_period: "Traditional Era",
            cultural_significance:
              "Represents traditional craftsmanship and cultural heritage",
          },
          heritage_facts: [],
